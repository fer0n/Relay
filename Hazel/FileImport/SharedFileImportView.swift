...
//  bringing Hazel to the foreground) starts with `source` nil and loads the
...
private let logger = Logger(subsystem: "com.pentlandFirth.Hazel", category: "SharedFileImportView")
