...
//  triggers on an Apple Wallet transaction and opens Hazel to add it.
...
struct AutomationTutorialView: View {
    ...
    private enum TutorialPage: Int, CaseIterable, Hashable, Sendable {
        ...
        var description: LocalizedStringKey {
            ...
            case .step7:
                return "Next time you pay with Apple Pay on your phone, Hazel will run automatically and add the transaction or prompt you with any necessary actions."
            }
        }
