...
//  Relay
//
//  Exists solely for the "YNAB Toolkit → Relay Migration" migration Shortcut, which
//  hands Relay the old "Transaction → YNAB" Shortcut's DataJar buckets/
...
//  File. Deliberately kept out of RelayShortcuts' promoted App Shortcuts
