...
nonisolated protocol StatementFileSource {
    var filename: String { get }
    var data: Data { get }
    var type: UTType? { get }
}

nonisolated extension IntentFile: StatementFileSource {}
...
nonisolated struct SharedStatementFile: StatementFileSource, Hashable, Identifiable {
    let filename: String
    let data: Data
    let type: UTType?
